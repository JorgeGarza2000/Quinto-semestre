...
form = new Form("form", new Item[]{getTextField(), getA(), getB(), getR()});//GEN-BEGIN:|14-getter|1|14-postInit
...
//<editor-fold defaultstate="collapsed" desc=" Generated Getter: textField ">//GEN-BEGIN:|33-getter|0|33-preInit
    /**
    ...
    public TextField getTextField() {
        if (textField == null) {//GEN-END:|33-getter|0|33-preInit
 // write pre-init user code here
textField = new TextField("Elija la operacion que desea realizar en el menu", null, 32, TextField.ANY);//GEN-LINE:|33-getter|1|33-postInit
 // write post-init user code here
